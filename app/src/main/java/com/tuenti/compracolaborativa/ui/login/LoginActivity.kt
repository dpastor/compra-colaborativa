...
import com.tuenti.compracolaborativa.MainActivity
...
//        }
        ...
        loginViewModel.loginFormState.observe(this@LoginActivity, Observer {
            ...
            if (loginState.addressDetailError != null) {
                address_detail.error = getString(loginState.addressDetailError)
            }
        })
...
//            }
        ...
        address_detail.afterTextChanged { updateViewModel() }

        login.setOnClickListener {
            loading.visibility = View.VISIBLE
            loginViewModel.login(this, name.text.toString(), address.text.toString(), address_detail.text.toString(), radio_buyer.isChecked)
        }
    }
